...
function Dashboard() {
  ...
  return (
    <div>
      <div style={{ backgroundColor: 'lightgreen', padding: '10px', marginBottom: '20px', border: '2px solid black' }}>
        {cart.length === 0 ? (
      ...
      {data.length === 0 ? (
        ...
        <div>
          {data.map((ele) => (
            <div
              key={ele.id}
              style={{ border: '1px solid black', margin: '10px', padding: '10px', width: '600px' }}
            >
